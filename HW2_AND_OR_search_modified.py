...
"I wonder if the stars are lit up so that each one of us can find her own star a gain.",
...
while (again=="yes"):
        ...
        for i,quote in enumerate(data_list):
               ...
               for word in words:
                       n=set({})
                       for x,sentance in enumerate(data_list):
                               if word in sentance:
                                       n.add(x)  
                ...
                for query in Query_list:
                        ...
                        if found == len(Query_list):
                                for slots in (sorted(slot_set)):
                                              print("\nFound at... ",slots,data_list[slots])
                dt2=datetime.now()
                ...
                for query in Query_list:
                        if query in words_dict:
                                ...
                                for slots in (sorted(slot_set)):
                                               print("\nFound at... ",slots,data_list[slots])
                dt4=datetime.now()
                print("\n\nTotal Search time = ",dt4.microsecond-dt3.microsecond," microsecnds")        
